#!/bin/bash
# Tears down the InvenTree stack completely.
...
# Note: INVENTREE_DB_PASSWORD and INVENTREE_ADMIN_PASSWORD in .env are not
#       reset — replace them with GENERATE_ME beforehand for a fully fresh
