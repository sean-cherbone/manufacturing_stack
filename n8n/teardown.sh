#!/bin/bash
# Tears down the n8n stack completely.
...
# Note: N8N_ENCRYPTION_KEY and RUNNERS_AUTH_TOKEN in .env are not reset —
#       replace them with OVERWRITE_ME beforehand for a fully fresh install.
set -e
