#!/bin/bash
# Tears down the BookStack stack completely.
...
# Note: APP_KEY in .env is not reset — replace it with GENERATE_ME beforehand
#       if you want a fully fresh install on the next start.
set -e
