#!/bin/bash
# Tears down the wg-easy stack completely.
# Removes all containers, volumes, images, and networks created by this service.
#
# WARNING: the wg_data volume (WireGuard keys + client configs) is permanently
# deleted. All existing VPN client configurations will stop working.
...
echo ""
echo "Volumes  (ALL VPN CONFIG WILL BE LOST):"
